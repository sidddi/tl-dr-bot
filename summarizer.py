...
SYSTEM_PROMPT = """Eres un asistente de investigación. Dado el texto de un artículo, devuelve SOLO un objeto JSON con estos campos:
...
Devuelve solo el objeto JSON sin bloques de código ni texto extra.""".format(
